...
const Working = () => {
  return (
      <div className="mt-20 pb-5">
            ...
            <div className="text-lg mb-10 m-auto text-mine-shaft-300 text-center w-1/2">Effortlessly navigate through the process and land your dream job!</div>
            <div className="flex px-16 justify-between items-center">
                <div className="relative">
                    <img className="w-120" src="/Working/Girl.png" alt="girl" />
                    <div className="w-36 flex top-[15%] right-0  absolute flex-col gap-1 items-center border border-bright-sun-400 rounded-xl py-3 px-1 backdrop:blur-md">
