  ...
  return (
    <div className="flex items-center px-16">
      ...
      <div className="w-[55%] flex items-center justify-end">
        ...
        <div className="absolute right-10 w-fit top-[28%] border-bright-sun-400 border rounded-lg p-2 backdrop:backdrop-blur-md ">
        ...
        <div className="absolute left-5 w-fit top-[50%] border-bright-sun-400 border rounded-lg p-2 backdrop:backdrop-blur-md gap-3 flex flex-col">
